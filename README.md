...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/talitatech/portifolio-gen.git
   ```
...
Este site está disponível publicamente através do **GitHub Pages**. Acesse:

🔗 [https://talitatech.github.io/portifolio-gen](https://talitatech.github.io/portifolio-gen)
